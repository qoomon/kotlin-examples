...
import me.qoomon.enhancements.archunit.CLASSES_SHOULD_NOT_ACCESS_PACKAGE_INTERNAL_ELEMENTS_FROM_OUTSIDE_ITS_PACKAGE
...
class ArchUnitTest {
    ...
    fun `ensure no illegal access to internal package elements`(classes: JavaClasses) {
        CLASSES_SHOULD_NOT_ACCESS_PACKAGE_INTERNAL_ELEMENTS_FROM_OUTSIDE_ITS_PACKAGE.check(classes)
    }
}
